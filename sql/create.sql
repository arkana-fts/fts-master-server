-- Script for building up an Arkana-FTS server-database (0.9.12).
--
...
--
-- Base de données: `arkanaftfts`
--

-- --------------------------------------------------------

--
-- Structure de la table `channelOps`
--

DROP TABLE IF EXISTS `channelOps`;
CREATE TABLE IF NOT EXISTS `channelOps` (
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `logged_in_where` int NOT NULL default '0',
  `location` text,
  `signup_date` datetime default NULL,
  `last_online` datetime default NULL,
  `week_online` int unsigned NOT NULL default '0',
  `total_online` int unsigned NOT NULL default '0',
  `wins` int unsigned NOT NULL default '0',
  `looses` int unsigned NOT NULL default '0',
...
--
-- Structure de la table `user_gamepage`
--

DROP TABLE IF EXISTS `user_gamepage`;
...
--
-- Structure de la vue `v_channelOps`
--
